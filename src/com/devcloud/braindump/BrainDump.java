...
import com.devcloud.braindump.R;
...
public class BrainDump extends Activity {
  ...
  private String mOriginalContent;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Sets the layout for this Activity. See res/layout/main.xml
  ...
  protected void onResume() {
      ...
      if (mCursor != null) {
          ...
          if (mState == STATE_EDIT) {
              ...
              int colTitleIndex = mCursor.getColumnIndex(Notes.COLUMN_NAME_TITLE);
